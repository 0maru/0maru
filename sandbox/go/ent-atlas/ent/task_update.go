...
func (tu *TaskUpdate) SetAge(i int) *TaskUpdate {
...
func (tu *TaskUpdate) AddAge(i int) *TaskUpdate {
...
// SetAge sets the "age" field.
func (tuo *TaskUpdateOne) SetAge(i int) *TaskUpdateOne {
...
// AddAge adds i to the "age" field.
func (tuo *TaskUpdateOne) AddAge(i int) *TaskUpdateOne {
