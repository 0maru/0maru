...
import (
	...
	"github.com/0maur/0maru/sandbox/go/entgql-gqlgen-postgres-uuid-id/ent/predicate"
	"github.com/0maur/0maru/sandbox/go/entgql-gqlgen-postgres-uuid-id/ent/todo"
)
