...
func (ec *executionContext) _Query_todos(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	res := resTmp.([]*ent.Todo)
	fc.Result = res
	return ec.marshalNTodo2ᚕᚖgithubᚗcomᚋ0maruᚋ0maruᚋsandboxᚋgoᚋgoᚑentᚑgqlgenᚑatlasᚋentᚐTodoᚄ(ctx, field.Selections, res)
}
...
func (ec *executionContext) marshalNTodo2ᚕᚖgithubᚗcomᚋ0maruᚋ0maruᚋsandboxᚋgoᚋgoᚑentᚑgqlgenᚑatlasᚋentᚐTodoᚄ(ctx context.Context, sel ast.SelectionSet, v []*ent.Todo) graphql.Marshaler {
	ret := make(graphql.Array, len(v))
	var wg sync.WaitGroup
	isLen1 := len(v) == 1
	if !isLen1 {
